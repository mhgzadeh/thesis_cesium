class MovingObject {
    constructor(viewer, traktorPath) {
        ...
        this._configTime();
        this.movableObjPosition = this._computeTimePositionadjastment(this.traktorPath)
    };
    ...
    addMovableEntityToViewer = (url) => {
        this.viewer.entities.add({
            ...
            orientation: new Cesium.VelocityOrientationProperty(this.movableObjPosition),
